...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Single GPU mode (Colab-friendly)
      torch.cuda.set_device(args.gpu)
      model = model.cuda(args.gpu)
    # Commenting out this NotImplementedError so it works in Colab
    # raise NotImplementedError("Only DistributedDataParallel is supported.")
    else:
    # Also allow CPU training or DataParallel fallback
      print("Warning: Running without DistributedDataParallel. Using single GPU or CPU.")
